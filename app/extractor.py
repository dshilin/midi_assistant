...
Верни ТОЛЬКО JSON объект:
{
  ...
  "min_thickness": минимальная подходящая пользователю толщина в мм (только число) или null. «толще 8 мм» → 9, «толщина 10 мм» → 10, «10-12 мм» → 10. Толщину НЕ выводи, если не упоминалась,
